...
const levels: { [key: string]: StaticLevel } = {
    "tutorial1":
    {
        ...
        text: {
            ...
            "4": `This is where this body's cybernetics come in handy. Walk up to the sentry vision and jump over it with %c{${COLORS.MOVE_LIGHT_BLUE}}(1)%c{}, then select the direction.`,
            ...
            "9": `Stand %c{${COLORS.MOVE_LIGHT_BLUE}}2 or 3 spaces from the enemy%c{}. Then use %c{${COLORS.MOVE_LIGHT_BLUE}}(5) enemy jump%c{} to jump over them. Be patient.`,
        
            "F": `This is impossible. But this body can take a hit and keep moving. Try to %c{${COLORS.MOVE_LIGHT_BLUE}}(4) Running Jump%c{} past these sentries. It won't work.`,
            "E": `That move requires some space to get moving; if an enemy sees you in those %c{${COLORS.MOVE_LIGHT_BLUE}}first three spaces%c{}, they'll shoot you. But after they shoot, they power down for a little bit.`,
